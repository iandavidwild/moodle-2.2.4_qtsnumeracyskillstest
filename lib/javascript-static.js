 ...
 * @param small
 */
M.util.add_audio_player = function (id, fileurl, small, autoplay, hidecontrols) {
    M.util.audio_players.push({id: id, fileurl: fileurl, small: small, autoplay: autoplay, hidecontrols: hidecontrols});
};
    ...
    if (typeof(flowplayer) == 'undefined') {
        ...
        var embed_function = function() {
            ...
            for(i=0; i<M.util.audio_players.length; i++) {
                ...
                // IDW 02/07/12 Have we got this far? Do we have a URL?
            	//alert(audio.fileurl);
                ...
                // IDW 02/07/12 
                //alert(audio.hidecontrols);
                
                if(audio.hidecontrols) {
                	controls.play = false;
                ...
                flowplayer(audio.id, M.cfg.wwwroot + '/lib/flowplayer/flowplayer-3.2.7.swf', {
                    ...
                    clip: {url: audio.fileurl, provider: "audio", autoPlay: audio.autoplay}
                	});
            }
        }
