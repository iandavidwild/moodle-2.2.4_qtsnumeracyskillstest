...
$string['configquestiontimelimit'] = 'Default time limit for quiz questions in minutes. 0 mean no time limit.';
$string['configquestiontimelimitsec'] = 'Default time limit for quiz questions in seconds. 0 mean no time limit.';
...
$string['questiontimelimit'] = 'Question time limit';
$string['questiontimelimit_help'] = 'If enabled, a time limit is applied to each question. When the time limit is up, the question is submitted automatically (with whatever answers have been filled in so far) and the next question is displayed.';
...
$string['questiontimelimitmin'] = 'Question time limit (minutes)';
$string['questiontimelimitsec'] = 'Question time limit (seconds)';
